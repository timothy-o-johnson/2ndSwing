// EditItemAttributes
// https://4537321-sb1.app.netsuite.com/app/common/scripting/script.nl?id=43&whence=

var customscript_wms_itemattributeeditorContext = {
  request: {
    type: 'http.ServerRequest',
    method: 'GET',
    url: 'https://4537321-sb1.app.netsuite.com/app/site/hosting/scriptlet.nl',
    parameters: {
      cacheKey: 'inventoryitem:2799392',
      whence: '',
      compid: '4537321_SB1',
      script: '43',
      deploy: '1'
