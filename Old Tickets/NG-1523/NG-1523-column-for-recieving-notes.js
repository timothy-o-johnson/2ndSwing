 ...
 * to determine the right field, looked at a purchase order and did an xml
 * Receiving Notes field = custcol_wms_recvnotes
 * 
 * Error when trying to use SDF An error occurred during custom object update.
Details: Permission Violation: You need a higher level of the 'Custom Lists' permission to access this page. Please contact your account administrator.
File: ~/Objects/customlistintegrationstatuses.xml
Object: customlistintegrationstatuses (customlist)
2019-10-09 05:50:56 (PST) Installation FAILED (0 minutes 23 seconds)


// NG-1523- Select Receiving Line Script Deployment
